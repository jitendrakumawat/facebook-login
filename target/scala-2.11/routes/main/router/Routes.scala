...
class Routes(
  ...
  // @LINE:7
  private[this] lazy val controllers_HomeController_dashboard1_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("dashboard")))
  )
  private[this] lazy val controllers_HomeController_dashboard1_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:7
    case controllers_HomeController_dashboard1_route(params) =>
      call { 
        controllers_HomeController_dashboard1_invoker.call(HomeController_0.dashboard)
      }
